(function () {
  ...
  const PRICING = [
    { title: "Мини-сайт", price: "от 7 000 ₽", note: "Для простой презентации услуги, контактов или быстрого старта.", tag: "Быстрый старт", features: ["Оффер и контакты", "Адаптив", "Форма заявки"] },
    { title: "Лендинг", price: "от 12 000 ₽", note: "Для рекламы, заявок и продажи одной услуги с понятным сценарием.", tag: "Реклама", features: ["Первый экран", "Блоки доверия", "Заявка"] },
    { title: "Каталог / мини-магазин", price: "от 15 000 ₽", note: "Для товаров, категорий, карточек и заказов без лишней сложности.", tag: "Популярный", features: ["Категории", "Карточки товаров", "Быстрый заказ"] },
    { title: "Telegram-бот", price: "от 3 000 ₽", note: "Для заявок, уведомлений, простых сценариев и связи с клиентом.", tag: "Автоматизация", features: ["Сценарии", "Уведомления", "Заявки"] },
    { title: "Поддержка", price: "от 500 ₽/мес", note: "Правки, обновления и сопровождение сайта после запуска.", tag: "После запуска", features: ["Правки", "Обновления", "Помощь"] },
  ];

  const FAQ_ITEMS = [
    { category: "price", question: "Сколько стоит сайт?", answer: "Стоимость зависит от формата. Мини-сайт начинается от 7 000 ₽, лендинг от 12 000 ₽, каталог или мини-магазин от 15 000 ₽. Точный расчёт фиксируется после уточнения задачи." },
