(function () {
  ...
  const PRICING = [
    { title: "Start", price: "от 39 000 ₽", note: "Быстрый старт для малого бизнеса и экспертов.", tag: "Быстрый запуск", features: ["Готовый шаблон", "Базовая настройка и контент", "Адаптивная версия", "Форма заявки", "SEO-база", "Запуск от 48 часов"] },
